...
export class ConferenceApp {
  ...
  appPages: PageInterface[] = [
    { title: 'Home', name: 'TabsPage', component: TabsPage, tabComponent: HomePage, index: 0, icon: 'ios-home' },
    { title: 'Jogadores', name: 'TabsPage', component: TabsPage, tabComponent: JogadoresPage, index: 1, icon: 'contacts' },
